    ...
    <>
      ...
      <div className="home">
        ...
        <div className="home-components">
              ...
              <div className="sidebar-header">
                ...
                >
                  <img
                    ...
                    src={
                      user?.avatar
                        ? `${config.UPLOAD_URL}uploads/${user.avatar}`
                        : defaultAvatar
                    }
                    alt=""
                  />
                </IconButton>
                <span className="sidebar-mobile-profile-name">
                  {user?.username}
                </span>
          ...
          <MessageContainer
            currentchat={currentchat}
            chatroomtiles={chatroomtiles}
            arrivalChat={arrivalChat}
            setArrivalChat={setArrivalChat}
          />
        </div>
      </div>
    </>
