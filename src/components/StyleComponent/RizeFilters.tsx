...
import { ACTIVE_CHAINS, CATEGORIES, PLATFORM_NETWORKS } from "app/config";
...
const ChainRadios = [
  ...
  {
    name: ACTIVE_CHAINS[PLATFORM_NETWORKS.COREUM].name,
    id: PLATFORM_NETWORKS.COREUM,
  },
  {
    name: ACTIVE_CHAINS[PLATFORM_NETWORKS.ETHEREUM].name,
    id: PLATFORM_NETWORKS.ETHEREUM,
  },
  {
    name: ACTIVE_CHAINS[PLATFORM_NETWORKS.BSC].name,
    id: PLATFORM_NETWORKS.BSC,
  },
  {
    name: ACTIVE_CHAINS[PLATFORM_NETWORKS.POLYGON].name,
    id: PLATFORM_NETWORKS.POLYGON,
  },
  {
    name: ACTIVE_CHAINS[PLATFORM_NETWORKS.AVALANCHE].name,
    id: PLATFORM_NETWORKS.AVALANCHE,
  },
  {
    name: ACTIVE_CHAINS[PLATFORM_NETWORKS.XRPL].name,
    id: PLATFORM_NETWORKS.XRPL,
  },
];
...
const RizeFilters = (props) => {
  ...
  const handleChangeChain = (id: number) => {
    setChain(id);
    if (props.onChangeChain !== undefined) props.onChangeChain(id);
  };
  ...
  useEffect(() => {
    ...
    if (props.chainValue !== undefined) setChain(props.chainValue);
  }, [props]);

  const renderXClear = () => {
    return (
      <span className="flex-shrink-0 w-4 h-4 rounded-full bg-[#33ff00] text-gray-900 flex items-center justify-center ml-3 cursor-pointer">
        <svg
  ...
  const renderTabsCategories = () => {
    return (
      <div className="relative dropdown">
        <div className="pb-2">
          <div
            className={`flex items-center justify-center px-3 py-1.5 text-xs rounded-full border focus:outline-none !border-primary-1000 bg-primary-1000 text-gray-900`}
          >
  ...
  const renderTabsSortOrder = () => {
    return (
      <div className="relative dropdown">
        <div className="pb-2">
          <div
            className={`flex items-center justify-center px-3 py-1.5 text-xs border rounded-full focus:outline-none !border-primary-1000 bg-primary-1000 text-gray-900`}
          >
            <svg className="w-4 h-4" viewBox="0 0 20 20" fill="none">
              <path
  ...
  const renderTabsFileTypes = () => {
    return (
      <div className="relative dropdown">
        <div className="pb-2">
          <div
            className={`flex items-center justify-center px-3 py-1.5 text-xs rounded-full border focus:outline-none bg-primary-1000 text-gray-900 border-primary-1000`}
          >
            <svg
              className="w-4 h-4"
              viewBox="0 0 24 24"
  ...
  const renderTabsPriceRage = () => {
    return (
      <div className="relative dropdown ">
        <div className="pb-2">
          <div
            className={`flex items-center justify-center px-3 py-1.5 text-xs rounded-full border border-primary-1000 bg-primary-1000 text-gray-900 focus:outline-none `}
          >
            <svg
              className="w-4 h-4"
              viewBox="0 0 24 24"
        ...
        <div className="dropdown-content  translate-x-0 left-0 px-4 sm:px-0 ">
          <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-[#191818] border border-neutral-200 dark:border-primary-1000">
    ...
    return (
      <div className="relative dropdown">
        ...
        <div className="dropdown-content left-0 translate-x-0 px-4 sm:px-0">
          <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-[#191818] border border-neutral-200 dark:border-primary-1000">
            <div className="relative flex flex-col px-5 py-6 space-y-5">
              {ChainRadios.map((item, index) => (
                <div key={index} className="">
                  <Radio
                    id={item.name}
                    name="radioChains"
                    label={item.name}
                    defaultChecked={chain === item.id}
                    onChange={(checked) => {
                      if (Boolean(checked) === true) handleChangeChain(item.id);
                    }}
                  />
                </div>
              ))}
    ...
    return (
      <div
        className={`flex items-center justify-center px-3 py-1.5 mb-2 text-xs rounded-full border focus:outline-none cursor-pointer  ${
          isVerifiedCreator
            ? "border-primary-1000 bg-primary-1000 text-gray-900"
      ...
      >
        ...
        <span className="line-clamp-1 ml-2">Verified</span>
  ...
  const renderTabMobileFilter = () => {
    return (
      <div className="flex-shrink-0">
        <div
          className={`flex flex-shrink-0 items-center justify-center px-3 py-1.5 text-xs rounded-full border border-primary-1000 bg-primary-1000 text-[#000000] focus:outline-none cursor-pointer`}
        ...
        <Transition appear show={isOpenMoreFilter} as={Fragment}>
          <Dialog
            as="div"
            className="fixed inset-0 z-50 px-[20px] w-[90%]"
  ...
  return (
    <div className="flex lg:space-x-4 justify-center">
      ...
      {/* FOR RESPONSIVE MOBILE */}
      <div className="flex overflow-x-auto lg:hidden space-x-4 justify-center">
