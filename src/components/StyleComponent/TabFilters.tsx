...
const TabFilters = (props) => {
  ...
  const renderXClear = () => {
    return (
      <span className="flex-shrink-0 w-4 h-4 rounded-full bg-[#33ff00] text-white flex items-center justify-center ml-3 cursor-pointer">
        <svg
          ...
          <>
            <Popover.Button
              className={`flex items-center justify-center px-3 py-1.5 text-xs rounded-full border focus:outline-none
               ${
                 open
                   ? "!border-[#33ff00] "
                   : "border-neutral-300 dark:border-[#33ff00]"
               }
                ${"!border-[#33ff00] bg-[#33ff00] text-[#33ff00]"}
                `}
            >
            ...
            >
              <Popover.Panel className="absolute z-40 w-screen max-w-sm px-4 mt-3 left-0 sm:px-0 lg:max-w-md">
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-[#191818] border border-neutral-200 dark:border-[#33ff00]">
    ...
    return (
      <Popover className="relative">
        {({ open, close }) => (
          <>
            <Popover.Button
              className={`flex items-center justify-center px-3 py-1.5 text-xs rounded-full border border-[#33ff00] bg-[#33ff00] text-[#33ff00] focus:outline-none `}
            >
              <svg
                className="w-4 h-4"
                viewBox="0 0 24 24"
                      ...
                      <div>
                        ...
                        <div className="mt-1 relative rounded-md">
                          ...
                          <input
                            ...
                            disabled
                            id="minPrice"
                            className="block w-32 pr-10 pl-4 sm:text-sm border-neutral-200 dark:border-[#33ff00] rounded-full bg-transparent"
                            value={rangePrices[0]}
                          />
                        </div>
                      </div>
    ...
    return (
      <div
        className={`flex items-center justify-center px-3 py-1.5 text-xs rounded-full border focus:outline-none cursor-pointer  ${
          isVerifiedCreator
            ? "border-[#33ff00] bg-[#33ff00] text-[#33ff00]"
            : "border-neutral-300 dark:border-[#33ff00] text-neutral-700 dark:text-neutral-300 hover:border-neutral-400 dark:hover:border-neutral-500"
        }`}
  ...
  const renderTabMobileFilter = () => {
    return (
      <div className="flex-shrink-0">
        <div
          className={`flex flex-shrink-0 items-center justify-center px-3 py-1.5 text-xs rounded-full border border-[#33ff00] bg-[#33ff00] text-[#33ff00] focus:outline-none cursor-pointer`}
        ...
        <Transition appear show={isOpenMoreFilter} as={Fragment}>
          ...
          >
            <div className="min-h-screen text-center">
              ...
              >
                <div className="inline-flex flex-col w-full max-w-4xl text-left align-middle transition-all transform overflow-hidden rounded-2xl bg-white dark:bg-[#191818] dark:border dark:border-[#33ff00] dark:text-neutral-100 shadow-xl h-full">
