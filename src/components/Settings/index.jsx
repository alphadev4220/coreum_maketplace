...
import SwitchDarkMode from "components/Button/SwitchDarkMode";
          ...
          <Popover.Panel className="absolute z-10 w-screen max-w-[260px] px-4 mt-3 -right-10 sm:right-0 sm:px-0">
            <div className="overflow-hidden shadow-lg rounded-3xl ring-1 ring-black ring-opacity-5">
              <div className="relative grid grid-cols-2 gap-6 justify-around px-6 py-3 bg-white dark:bg-neutral-800">
                <button
                  className="text-2xl md:text-3xl w-12 h-12 rounded-full text-neutral-700 m-auto dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 focus:outline-none flex items-center justify-center"
                  onClick={openModal}
                >
                  <svg
                    fill="currentColor"
                      ...
                      <div className="tutorial-content">
                        ...
                        {item.id === 0 && (
                          <div className="flex justify-center items-center relative w-full">
                            ...
                            <span
                              className="mt-4 absolute right-0 cursor-pointer"
                              onClick={closeModal}
                            >
                              Skip
                            </span>
